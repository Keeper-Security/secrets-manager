...
export const ADDITIONAL_AUTHENTICATION_DATA = "keeper_auth";
export const TOKEN_SCOPE = "https://www.googleapis.com/auth/cloud-platform";
export const RAW_ENCRYPT_GCP_API_URL = "https://cloudkms.googleapis.com/v1/{}:rawEncrypt";
export const RAW_DECRYPT_GCP_API_URL = "https://cloudkms.googleapis.com/v1/{}:rawDecrypt";
export const SCOPES = [TOKEN_SCOPE];