...
- KSM-1219 - Updated js-yaml, handlebars, brace-expansion, and other dependencies to resolve open security advisories
- KSM-1219 - Removed unused `yarn.lock`; this package has only ever been installed via `npm ci` in CI
