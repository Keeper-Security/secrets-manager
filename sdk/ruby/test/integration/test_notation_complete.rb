  ...
  def test_complex_field_notation
    ...
    complex_data = {
      ...
      'custom' => [
        ...
        { 'type' => 'text', 'label' => 'Department', 'value' => ['Engineering', 'Research'] }
      ]
    }
  ...
  def test_totp_notation
    ...
    totp_data = {
      ...
      'fields' => [
        ...
        { 'type' => 'oneTimeCode', 'value' => ['otpauth://totp/Test:totp@example.com?secret=JBSWY3DPEHPK3PXP&issuer=Test&algorithm=SHA1&digits=6&period=30'] }
      ]
    }
