...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("Keeper Secrets Manager Azure KMS Storage")
                description.set("Azure Key Vault storage provider for Keeper Secrets Manager. " +
                        "Provides secure storage of KSM configuration using Azure Key Vault.")
...
configure<org.jreleaser.gradle.plugin.JReleaserExtension> {
    project {
        ...
        description = "Azure Key Vault storage provider for Keeper Secrets Manager"
