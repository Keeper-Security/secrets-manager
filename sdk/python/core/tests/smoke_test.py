...
class SmokeTest(unittest.TestCase):
    ...
    def test_client_version(self):
        ...
        with patch("importlib_metadata.version") as mock_meta:
            ...
            self.assertEqual("16.1.0", client_version, "did not get the correct client version from 0.1.23a0")

        with patch("importlib_metadata.version") as mock_meta:
            mock_meta.return_value = "0.2.24"

            client_version = get_client_version()
            self.assertEqual("16.2.0", client_version, "did not get the correct client version from 0.2.24")
